...
worksheet = client.open('Project Tracker - SD 2.0').get_worksheet(2)
...
try:
    ...
    driver.find_element_by_xpath('/html/body/div/main/div[2]/div[1]/form/div[4]/button').click()

# Filters
keyword = "BigData engineer"
page = 12
keyword.replace(" ", "%20")
search_url = 'https://www.linkedin.com/search/results/people/?facetGeoRegion=%5B%22in%3A0%22%5D&facetNetwork=%5B%22S%22%2C%22O%22%5D&keywords='+ keyword + '&origin=GLOBAL_SEARCH_HEADER&page='
driver.get(search_url+str(page))
message = '''We, at upGrad, are looking for SMEs for our upcoming online software development programs. We believe that it’s an ideal opportunity for us to make rigorous higher education accessible to a wider audience. This will be a part-time engagement, and we will be working remotely. Thanks!'''
...
while i < 20:
    ...
    try:
        try:
            driver.find_element_by_xpath('/html/body/div[8]/div[3]/div/div[2]/div/div/div/div[2]/ul/li[' + str(li_id) + ']/div/div/div[2]/div[1]/div/div[1]/span/div/span[1]/span/a/span/span[1]').click()
        except:
            driver.find_element_by_xpath('/html/body/div[7]/div[3]/div/div[2]/div/div/div/div[2]/ul/li[' + str(li_id) + ']/div/div/div[2]/div[1]/div/div[1]/span/div/span[1]/span/a/span/span[1]').click()
    ...
    if exp > 3 and name != "Unable to find":
        ...
        if company_name != "NA" and process.extractOne(company_name,top_companies)[1]>80:
            confidence_level += 2
        ...
        elif fuzz.partial_ratio("Lead".lower(),job_title.lower())>95:
            confidence_level += 1
            comm.append("Senior role")
        ...
        if confidence_level >= 50 and Connect_flag:
            ...
            try:
                try:
                    try:
                        driver.find_element_by_xpath('/html/body/div[8]/div[3]/div/div/div/div/div[2]/main/div[1]/section/div[2]/div[1]/div[2]/div/div/div[1]/div/button/span').click()
                    except:
                        driver.find_element_by_xpath('/html/body/div[7]/div[3]/div/div/div/div/div[2]/main/div[1]/section/div[2]/div[1]/div[2]/div/div/div[1]/div/button/span').click()
                except:
                    try:
                        ...
                        driver.find_element_by_xpath('/html/body/div[7]/div[3]/div/div/div/div/div[2]/main/div[1]/section/div[2]/div[1]/div[2]/div/div/div/div/div/div/ul/li[4]/div/div/li-icon').click()
                ...
                comm.append("UNABLE TO CONNECT_PLEASE ADD MANUALLY")
